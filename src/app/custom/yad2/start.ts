...
@Component({
    ...
    providers: [ BrowserDomAdapter ,TranslateService, Modal],
    pipes: [TranslatePipe],
...
export class ShowAlterImagesYad2  {
    ...
    constructor(private modal: Modal, private _dom: BrowserDomAdapter,private translate: TranslateService, public showimageService: ShowimageService,
    ...
    //s    var a = showimageService.picWidth *2+80;
      console.log(this.obj);
        ...
        window.angularComponentRefStart = {
             zone: this.zone,
    ...
    openDialog(type: string,img1: string,img2: string, obj) {
      ...
      if(type == 'edit'){
        ...
        config = new ModalConfig("md", true, 27);
        mod = new ShowAlterImagesWindowData(img1,img2,obj.imageSize.height, obj.imageSize.width, obj);
      //  console.log(mod);
        mod.lang = this._localSetting.getLanguage();
        mod.applyTransparent = this.applyTransparent;
        component = ShowAlterImagesWindow ;//(type === 'customWindow') ? AdditionCalculateWindow : YesNoModal;
        let bindings = Injector.resolve([
          provide(ICustomModal, {useValue: mod})
        ]);
      }
      ...
      dialog = this.modal.open(
        ...
        dialog.then((resultPromise) => {
          ...
          //  this.lastModalResult = result;
            ...
            if(result == false){
              console.log("false",this.lastResultUrl);
    ...
    //console.log(this.mod.obj.resultEditMaskImageUrl = this.mod.resultEditMaskImageUrl);
            //  this.mod = new EditImagesWindowData(img1,this.mod.resultEditMaskImageUrl,this.mod.obj,this.apiUrl);
            //  this.mod.applyShadow = this.applyShadow;
          //    this.mod.lang = this._localSetting.getLanguage();
              ...
              console.log(this.mod);
              this.openDialog('view',obj.originalImageUrl,res,obj);

            } // end false;
          //  console.log(mod);
            if(result == "openResult"){
              this.lastResultUrl = this.mod.resultUrl;
        //      console.log("openResult");
          //    console.log(this.mod);
        //      console.log(this.lastResultUrl);

              this.lastEditedStuff = this.mod.editedStuff;
        //      console.log(this.lastEditedStuff);
        //      console.log("openResult");


              this.openDialog('',obj.originalImageUrl,this.mod.resultUrl,this.mod.obj);
            }
    ...
    saveImage(){
      ...
      window.backgroundRemovalCallback(this.mod.resultUrl);
